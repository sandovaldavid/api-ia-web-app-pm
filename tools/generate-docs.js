...
const markdownFiles = fs.readdirSync(guidesDir).filter((file) => file.endsWith('.md') && file !== 'README.md');
...
markdownFiles.forEach((mdFile) => {
    ...
    try {
        ...
        htmlContent = htmlContent.replace(new RegExp(`{{#if ${guideName}}}active{{/if}}`, 'g'), 'active');
